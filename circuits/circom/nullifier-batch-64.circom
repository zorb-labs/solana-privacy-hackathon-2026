...
// =============================================================================
//
// Proves batch insertion of 64 nullifiers into the indexed Merkle tree.
...
//   BATCH_SIZE = 64       Nullifiers inserted per batch
//
...
//   nullifiers[64]        Array of nullifiers to insert
//
// =============================================================================
component main {
    public [
...
} = NullifierBatchInsertSimple(MERKLE_TREE_HEIGHT(), 64);
